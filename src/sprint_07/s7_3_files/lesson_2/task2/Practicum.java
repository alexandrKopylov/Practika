package sprint_07.s7_3_files.lesson_2.task2;
...
public class Practicum {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (command) {
                case "ls":
                    if (Files.isDirectory(path)) { // проверьте, не ошибся ли пользователь
                    try {
                ...
                case "rename":
                    ...
                    try {
                            Files.move(path, Paths.get(newName), StandardCopyOption.REPLACE_EXISTING); // с помощью опции StandardCopyOption.REPLACE_EXISTING
